...
namespace Common.Server
{
    public static class ServerRequest
    {
        ...
        /// <typeparam name="T">The type of data expected in the response.</typeparam>
        /// <returns>A ResponseModel containing the success status and data.</returns>
        public static async UniTask<ResponseModel<T>> PostRequest<T>(string url, string jsonBody,
        ...
        /// <typeparam name="T">The type of data expected in the response.</typeparam>
        /// <returns>A ResponseModel containing the success status and data.</returns>
        public static async UniTask<ResponseModel<T>> PatchRequest<T>(string url, string jsonBody,
            string bearerToken = null)
        {
        ...
        private static UnityWebRequest CreateOutgoingRequest(string type, string url, string jsonBody = null,
            string bearerToken = null)
        {
